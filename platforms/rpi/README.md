...
Tangram will be rendered directly to the screen without a window manager. To show a mouse cursor, run the application with the `-m`:
...
To build in `RELEASE` or `DEBUG` mode run the following:
